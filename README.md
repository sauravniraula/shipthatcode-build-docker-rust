...
[![shipthatcode — Build Your Own Docker](https://api.shipthatcode.com/cert/4a80dabd3f4135494929f70e940dd47e.svg)](https://shipthatcode.com/courses/build-docker)

My working repo for [Build Your Own Docker](https://shipthatcode.com/courses/build-docker) on [shipthatcode.com](https://shipthatcode.com) — built lesson by lesson in my own editor.
...
3. In your terminal, inside the unzipped folder, push it to GitHub:
   ...
   git init
   git add .
   git commit -m "start Build Your Own Docker"
   git branch -M main
   git remote add origin https://github.com/YOUR-USERNAME/YOUR-REPO.git
   git push -u origin main
   ```

4. Paste your repo link on the [course page](https://shipthatcode.com/courses/build-docker) ("Work in your own editor" → **Link repo**). Done — you never do this again.
